...
class DataValidator:
    ...
    ENVELOPE_OPTIONAL_FIELDS = ['agent_version', 'host_id', 'timestamp',
                                 'data_type', 'checksum', 'compression']
    ...
    def validate_data_envelope(self, data: Dict[str, Any]) -> ValidationResult:
        ...
        try:
            ...
            missing_fields = [f for f in self.ENVELOPE_REQUIRED_FIELDS
                             if f not in data]
            if missing_fields:
            ...
            return ValidationResult(
                True,
                "Data envelope validation successful",
                details
            )
    ...
    def validate_system_data(self, changes: List[Dict[str, Any]]) -> ValidationResult:
        ...
        for i, change in enumerate(changes):
            if not isinstance(change, dict):
                ...
                details['validation_errors'].append({
                    'index': i,
                    'error': 'Change must be a dictionary'
                })
                continue
    ...
    def decompress_data(self, data: Union[str, bytes],
                       compression: str) -> Tuple[bool, Union[str, bytes], str]:
    ...
    def validate_checksum(self, data: Union[str, bytes],
    ...
    def validate_ndjson_format(self, data: str) -> ValidationResult:
        ...
        try:
            ...
            message = (f"NDJSON validation: {details['valid_lines']} valid, "
...
def calculate_checksum(data: Union[str, bytes],
